...
"""
    ...
    def build_ultra_prompt(self, search_data: Dict, context: str) -> str:
        ...
        # 基本プロンプト
        base_prompt = f"""あなたは頼れるパートナーとして、お客様のご質問にお答えします。豊富な知識と経験を活かして、実用的で分かりやすいアドバイスを心がけています。
...
• 不明な点があれば正直にお伝えし、確認方法もご案内します
• 連絡先や手続きについては、正確な情報を漏れなくお伝えします
• お客様が次に何をすべきかが明確になるよう、具体的にご案内します
